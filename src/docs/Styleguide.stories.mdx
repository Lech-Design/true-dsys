...
- **Micro Patterns** - resuasable collections of Mudblazor components that define structure and layout
- **Feature Patterns** - Examples of specific application features and layouts
